...
public class TicTacToeControllerTest {
  ...
  /**
   * Tests a single valid move by X and a quit by O.
   * Checks that the game board and game log are updated correctly.
   */
  @Test
  ...
  /**
   * Tests handling of bogus input as the row value for a move.
   * Checks that the game log reflects that the game was quit early due to invalid input.
   */
  @Test
  ...
  /**
   * Tests a full game that results in a tie.
   * Checks that the game board and game log are updated correctly, and that the game is declared a tie.
   */
  @Test
  ...
  /**
   * Tests handling of a failing appendable passed to the controller.
